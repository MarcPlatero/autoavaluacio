...
The project was built using Laravel, along with Vue.js, Blade, and PHP. The system works well overall, although there are still some features that could be added. Not all possible functionalities were required — only the most essential ones were implemented. To ensure you don’t miss anything, I recommend exploring each role and clicking through all available options. The design wasn’t a priority — it’s quite basic and was mainly built to demonstrate functionality. Some components, like “Mòduls”, are not yet implemented and are currently displayed in the same way as “Cicles”, just to showcase the basic structure and functionality.
